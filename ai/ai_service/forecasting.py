...
class Forecaster:
    def __init__(self):
        self.point = HistGradientBoostingRegressor(loss="poisson", max_depth=6, learning_rate=0.08, max_iter=300)
        self.q = {}
        for tag, qv in [("p10", 0.10), ("p50", 0.50), ("p90", 0.90)]:
            self.q[tag] = HistGradientBoostingRegressor(
                loss="quantile", quantile=qv, max_depth=6, learning_rate=0.08, max_iter=250
            )
